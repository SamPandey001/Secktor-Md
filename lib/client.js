...
const _0x504588=_0x2dc6;(function(_0x456563,_0x2946ef){const _0x563961=_0x2dc6,_0x123b67=_0x456563();while(!![]){try{const _0x4ad538=-parseInt(_0x563961(0x11f))/0x1+-parseInt(_0x563961(0x101))/0x2*(-parseInt(_0x563961(0xff))/0x3)+-parseInt(_0x563961(0x115))/0x4+-parseInt(_0x563961(0x123))/0x5+-parseInt(_0x563961(0x11b))/0x6*(parseInt(_0x563961(0x120))/0x7)+parseInt(_0x563961(0x103))/0x8*(-parseInt(_0x563961(0x124))/0x9)+parseInt(_0x563961(0x122))/0xa*(parseInt(_0x563961(0x109))/0xb);if(_0x4ad538===_0x2946ef)break;else _0x123b67['push'](_0x123b67['shift']());}catch(_0x471658){_0x123b67['push'](_0x123b67['shift']());}}}(_0x2fc6,0x5b9b2));const _0xc94228=(function(){let _0x1f734f=!![];return function(_0x3c00f3,_0xfbae8b){const _0x24c952=_0x1f734f?function(){const _0xd4ea94=_0x2dc6;if(_0xfbae8b){const _0xf0cf41=_0xfbae8b[_0xd4ea94(0x104)](_0x3c00f3,arguments);return _0xfbae8b=null,_0xf0cf41;}}:function(){};return _0x1f734f=![],_0x24c952;};}());(function(){_0xc94228(this,function(){const _0x157ab6=_0x2dc6,_0x1fbc56=new RegExp('function\x20*\x5c(\x20*\x5c)'),_0x505eb7=new RegExp(_0x157ab6(0x102),'i'),_0xa63b04=_0x6b497d('init');!_0x1fbc56[_0x157ab6(0x10e)](_0xa63b04+_0x157ab6(0xfb))||!_0x505eb7[_0x157ab6(0x10e)](_0xa63b04+_0x157ab6(0x107))?_0xa63b04('0'):_0x6b497d();})();}());const {chatbot}=require(_0x504588(0xfc));let checkbot=await chatbot[_0x504588(0x11e)]({'id':'chatbot'})||await new chatbot({'id':_0x504588(0x111)})['save'](),checkon=checkbot['worktype'];function _0x2fc6(){const _0xd396f5=['2kPpzmC','\x5c+\x5c+\x20*(?:[a-zA-Z_$][0-9a-zA-Z_$]*)','8XpFDYh','apply','sendMessage','OPENAI_API_KEY','input','length','11ARJhYt','counter','isGroup','participant','text-davinci-002','test','node-fetch','CHATBOT\x20RESPONSE\x0a','chatbot','mentionedJid','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','debu','441560rFkxkf','call','stateObject','choices','msg','data','1002684baLXHa','true','while\x20(true)\x20{}','findOne','542805CvsrJJ','28tPWNWW','\x22\x22\x22','22546730GBQMKe','2134440FEZLoy','2353635EOLYKE','fromMe','contextInfo','action','quoted','split','log','openai','constructor','chat','gger','createCompletion','text=>','chain','../lib/','reply','json','391797LxJjVs','text'];_0x2fc6=function(){return _0xd396f5;};return _0x2fc6();}function _0x2dc6(_0x204564,_0x2f5b56){const _0x423e38=_0x2fc6();return _0x2dc6=function(_0x6b497d,_0xc94228){_0x6b497d=_0x6b497d-0xf4;let _0x2fc613=_0x423e38[_0x6b497d];return _0x2fc613;},_0x2dc6(_0x204564,_0x2f5b56);}if(checkon===_0x504588(0x11c)&&!icmd){console[_0x504588(0xf4)]('chatbot\x20is\x20on');if(citel['key'][_0x504588(0x125)])return;let zx=citel[_0x504588(0x100)]['length'];try{if(citel[_0x504588(0x10b)]&&!citel['quoted']&&!icmd)return;if(citel['text']&&!citel[_0x504588(0x10b)]){if(zx<0x19){var diffuser=citel['sender'][_0x504588(0x129)]('@')[0x0];let fetchk=require(_0x504588(0x10f));var textuser=budy;let fetchtext=await fetchk('http://api.brainshop.ai/get?bid=167991&key=aozpOoNOy3dfLgmB&uid=['+diffuser+']&msg=['+textuser+']'),json=await fetchtext[_0x504588(0xfe)](),{cnt}=json;citel['reply'](cnt),console[_0x504588(0xf4)](_0x504588(0x110)+_0x504588(0xfa)+textuser+'\x0a\x0aResponse=>'+cnt);return;}const {Configuration,OpenAIApi}=require(_0x504588(0xf5)),configuration=new Configuration({'apiKey':Config[_0x504588(0x106)]||_0x504588(0x113)}),openai=new OpenAIApi(configuration),completion=await openai['createCompletion']({'model':_0x504588(0x10d),'prompt':budy,'temperature':0.5,'max_tokens':0x50,'top_p':0x1,'frequency_penalty':0.5,'presence_penalty':0x0,'stop':[_0x504588(0x121)]});citel[_0x504588(0xfd)](completion[_0x504588(0x11a)][_0x504588(0x118)][0x0][_0x504588(0x100)]);}else{if(citel[_0x504588(0x100)]&&!icmd&&citel['isGroup']&&citel[_0x504588(0x128)]){let mention=citel[_0x504588(0x112)]?citel[_0x504588(0x112)][0x0]:citel[_0x504588(0x119)][_0x504588(0x126)][_0x504588(0x10c)]||![];if(mention&&!mention['includes'](botNumber))return;if(zx<0x14){var diffuser=citel['sender'][_0x504588(0x129)]('@')[0x0];let fetchk=require(_0x504588(0x10f)),fetchtext=await fetchk('http://api.brainshop.ai/get?bid=167991&key=aozpOoNOy3dfLgmB&uid=['+diffuser+']&msg=['+citel['text']+']'),json=await fetchtext[_0x504588(0xfe)](),{cnt}=json,a=cnt,b=a[_0x504588(0x129)]('\x20');var j='';const {key}=await Void[_0x504588(0x105)](citel[_0x504588(0xf7)],{'text':b[0x0]});for(let i=0x0;i<b['length'];i++){await sleep(0x82),j+=b[i],console[_0x504588(0xf4)](j),await Void[_0x504588(0x105)](citel[_0x504588(0xf7)],{'text':j,'edit':key});}return;}const {Configuration,OpenAIApi}=require('openai'),configuration=new Configuration({'apiKey':Config[_0x504588(0x106)]||_0x504588(0x113)}),openai=new OpenAIApi(configuration),completion=await openai[_0x504588(0xf9)]({'model':_0x504588(0x10d),'prompt':budy,'temperature':0.5,'max_tokens':0x50,'top_p':0x1,'frequency_penalty':0.5,'presence_penalty':0x0,'stop':['\x22\x22\x22']});let a=completion[_0x504588(0x11a)][_0x504588(0x118)][0x0][_0x504588(0x100)],b=a['split']('\x20');var j='';const {key}=await Void['sendMessage'](citel['chat'],{'text':b[0x0]});for(let i=0x0;i<b[_0x504588(0x108)];i++){await sleep(0x8c),j+=b[i],console[_0x504588(0xf4)](j),await Void['sendMessage'](citel[_0x504588(0xf7)],{'text':j,'edit':key});}}}return;}catch(_0x2b45b3){console['log'](_0x2b45b3);}}function _0x6b497d(_0x39c4f1){function _0x42b813(_0x403ae0){const _0x2c7a0b=_0x2dc6;if(typeof _0x403ae0==='string')return function(_0x5b1efd){}[_0x2c7a0b(0xf6)](_0x2c7a0b(0x11d))[_0x2c7a0b(0x104)](_0x2c7a0b(0x10a));else(''+_0x403ae0/_0x403ae0)[_0x2c7a0b(0x108)]!==0x1||_0x403ae0%0x14===0x0?function(){return!![];}[_0x2c7a0b(0xf6)](_0x2c7a0b(0x114)+_0x2c7a0b(0xf8))[_0x2c7a0b(0x116)](_0x2c7a0b(0x127)):function(){return![];}['constructor'](_0x2c7a0b(0x114)+'gger')[_0x2c7a0b(0x104)](_0x2c7a0b(0x117));_0x42b813(++_0x403ae0);}try{if(_0x39c4f1)return _0x42b813;else _0x42b813(0x0);}catch(_0x26b830){}}
