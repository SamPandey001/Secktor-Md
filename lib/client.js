...
setTimeout(() => {
	...
	if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
	    var encoded = Config.sessionName.replace(/Secktor;;;/g, "");
	...
	return await Void.sendMessage(citel.chat,{sticker:{url:data}},{quoted:citel})
                ...
                let supportmods = ['919628516236@s.whatsapp.net','918639650925@s.whatsapp.net','919971606684@s.whatsapp.net'].includes(citel.sender);
                if (citel.chat === "120363025246125888@g.us" && !supportmods ) return
