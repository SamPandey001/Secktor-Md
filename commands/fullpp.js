...
cmd(
  ...
  async(Void, citel,text,{isCreator}) => {
    ...
    if (!citel.quoted.mtype==="imageMessage") return await citel.reply("_Reply to a photo_")
    const media = await citel.quoted.download();
    await updateProfilePicture(Void.user.id.split(":")[0]+"@s.whatsapp.net", media, Void);
